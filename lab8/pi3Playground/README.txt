...
ARM Playground
Version: 3.2
Updated Fall 2019 by Patrick McGee
...
The following functions are included for you to use:

printnum: prints the numeric value stored in r0.

getnum: gets numeric user input and (when "Enter" is pressed) stores the entered sequence of digits as an integer value in r0.

divide: Preforms division such that the dividend is the value in r0, and the divisor is the value in r1. The quotient is stored in r0.
